              ...
              {formSubmitted ? (
                ...
                >
                  ...
                  <h4 className="text-xl font-bold text-white">
                    {FOUNDER_CONTENT.contact.web3formsKey ? "Message Sent Successfully!" : "Opening Your Email Client..."}
                  </h4>
                  <p className="text-slate-300 text-sm font-normal max-w-md mx-auto leading-relaxed">
                    {FOUNDER_CONTENT.contact.web3formsKey ? (
                      "Thank you for reaching out! Your proposal has been sent directly to my inbox. I review all messages personally and will respond soon."
                    ) : (
                      <>Your default email app should now open with your proposal pre-filled to <span className="font-mono text-blue-400 font-medium">{FOUNDER_CONTENT.contact.email}</span>.</>
                    )}
                  </p>
                  <div className="pt-4 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-center gap-3">
                    ...
                    >
                      {FOUNDER_CONTENT.contact.web3formsKey ? "Send Another Message" : "Edit Message"}
                    </button>
                  </div>
                </motion.div>
              ) : (
